...
object Untyped {
  ...
  /**
    ...
    */
  val criteria: Untyped = new Untyped {}
  ...
  def where(
      block: (Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped) => Expression
  ): Expression =
  ...
  def where(
      block: (Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped, Untyped) => Expression
  ): Expression =
